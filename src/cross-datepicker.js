...
(function () {
    ...
    function apply() {
        $("[data-cdp], [data-cross-datepicker]").each(function () {

            var e = $(this),
                d = {};

            for (var k in $.fn.cdp.defaults) {
                var v = e.data(k);
    ...
    $.fn.cdp.apply = apply;
    window.applyCrossDatePicker = apply;
    window.applyCDP = apply;
